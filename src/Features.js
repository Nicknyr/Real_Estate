            ...
            <Grid container justify="center">
                <Grid item xs={12} sm={4} md={3} className={classes.feature}>
                    <Box align="center">
                        ...
                        <Typography variant="h5" align="center" className={classes.h5}>Buy a home</Typography>
                ...
                <Grid item xs={12} sm={4} md={3} className={classes.feature}>
                    <Box align="center">
                        ...
                        <Typography variant="h5" className={classes.h5}>Rent a home</Typography>
                        <Typography variant="body1" className={classes.body}>
                ...
                <Grid item xs={12} sm={4} md={3} className={classes.feature}>
                    <Box align="center">
                        ...
                        <Typography variant="h5" className={classes.h5}>See neighborhoods</Typography>
                        <Typography variant="body1" className={classes.body}>
